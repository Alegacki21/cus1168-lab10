...
public class Lab10 {
    ...
    public static String deduplicate(String str) {
        ...
        // If there's only one character left, return it
        if (str.length() == 1) {
            return str;
        }
    ...
    public static int countHiSpecial(String str) {
        ...
        // Otherwise, move one character ahead
    ...
    public static int substringLength(String str, String sub) {
        ...
        // Try removing first character and last character
